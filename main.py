...
def reversrs():
    print("\033[96m{}\033[0m".format("--------------------------------"))
    Number1 = int(input("Kāds ir tavs pirmais cipars?: "))
    Number2 = int(input("Kāds ir tavs otrais cipars?: "))
    print("\033[96m{}\033[0m".format("--------------------------------"))
...
def main():
    if __name__ == '__main__':
        choice = input(
            "\033[93m Labais,izvelies funkciju\n"
            "\033[97m Ievadi burtu:\n"
            "\033[94mFunction 1 - which you will know all the divisors and the sum of them if you need this function write (d) \n"
            "\033[94mFunction 2 - the logic stays the same, only the number of numbers changes from one number to another if you need this function write (r)")
        if choice.lower() == 'd':
            dividers()
        if choice.lower() == 'r':
            reversrs()
